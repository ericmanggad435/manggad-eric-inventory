              ...
              {products.map((element, index) => {
                return (
                  <tr key={index}>
                    ...
                    <td>
                      <button
                        className="p-2 rounded bg-black text-white hover:bg-orange-700"
                        onClick={() => {
                      ...
                      <button
                        className="p-2 rounded bg-black text-white hover:bg-red-700"
...
<div className="m-5">
          <button className="p-2 rounded bg-black text-white hover:bg-green-700" onClick={handleShowAddProduct}>
            Add Product
          </button>
        </div>
